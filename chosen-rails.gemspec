...
Gem::Specification.new do |s|
  ...
  s.date = "2012-03-21"
  s.description = "Use Chosen with Rails 3 as a gem"
  ...
  s.files = [
    ...
    "vendor/assets/javascripts/select-parser.js.coffee",
    "vendor/assets/stylesheets/chosen.css"
  ]
  s.homepage = "http://github.com/kristianmandrup/chosen-rails"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.10"
  s.summary = "The Chosen javascript plugin packaged for Rails 3"
